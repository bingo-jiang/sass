...
class Pagination(object):
    ...
    def page_html(self):
        ...
        if self.current_page <= 1:
            ...
            prev = '<li><a href="%s?%s"><span aria-hidden="true">&laquo;</span></a></li>' % (self.base_url, self.query_params.urlencode())
        ...
        if self.current_page >= self.pager_count:
            ...
            self.query_params['page'] = self.current_page + 1
            nex = '<li><a href="%s?%s"><span aria-hidden="true">&raquo;</span></a></li>' % (self.base_url, self.query_params.urlencode(),)
